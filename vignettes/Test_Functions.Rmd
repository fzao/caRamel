...
vignette: >
  ...
  %\VignetteIndexEntry{Using the caRamel R package: simple test functions}
...
__Note that parameter *i* is mandatory for the management of parallelism.__
...
```{r schaffer_launch, include=FALSE}
results <-
  caRamel(nobj,
          nvar,
          minmax,
...
Test if the convergence is successfull:
...
Test if the convergence is successfull and plot the optimal front:
